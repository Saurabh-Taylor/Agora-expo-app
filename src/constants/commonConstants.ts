...
export const RAZORPAY_RETURN_URL = 'com.saurabh.agora://razorpay-complete';
export const SECURE_STORE_CHUNK_SIZE = 1800;
export const MAX_SECURE_STORE_CHUNKS = 32;
export const SECURE_STORE_VERSION = 2;
export const SECURE_STORE_KEY_SUFFIX = `v${SECURE_STORE_VERSION}`;
export const TOWER_SELECT = 'id, society_id, name, code, floors, units_per_floor, created_at';
export const FLAT_SELECT = 'id, society_id, tower_id, number, floor, created_at';
