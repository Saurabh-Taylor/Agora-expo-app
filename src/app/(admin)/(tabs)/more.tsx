...
const MODULES = [
  { label: 'Amenities', sub: 'Bookings & spaces', iconBg: '#E4EFF5', glyph: '🏊', go: () => showToast('Amenities — coming in a later phase') },
  { label: 'Polls & Surveys', sub: 'Community voting', iconBg: '#EFEAF7', glyph: '▤', go: () => showToast('Polls — coming in a later phase') },
  { label: 'Staff & Services', sub: 'Directory', iconBg: '#F6ECD8', glyph: '👷', go: () => showToast('Staff & Services — coming in a later phase') },
