...
export default function SplashScreen() {
  ...
  useEffect(() => {
    entrance.value = withTiming(1, { duration: 600, easing: Easing.bezier(0.2, 0.9, 0.3, 1.4) });
  ...
  return (
    <Pressable style={styles.flex} onPress={goNext}>
      <LinearGradient colors={[Colors.green400, Colors.green600, Colors.green800]} style={styles.flex}>
